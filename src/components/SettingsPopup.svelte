    ...
    <div class="option-list">
        <div class="option">
            ...
            <div class="option-section">
                ...
                <input type="color" id="income-colorPicker" bind:value={incomeColor}>
                <div class="option-grouping">
                    <label for="income-top-colorPicker">Top 10%</label>
                    <input type="color" id="income-top-colorPicker" bind:value={incomeTopColor}>
                    <label for="income-high-colorPicker">High</label>
                    <input type="color" id="income-high-colorPicker" bind:value={incomeHighColor}>
                    <label for="income-low-colorPicker">Low</label>
                    <input type="color" id="income-low-colorPicker" bind:value={incomeLowColor}>
                    <label for="income-bottom-colorPicker">Bottom 10%</label>
                    <input type="color" id="income-bottom-colorPicker" bind:value={incomeBottomColor}>
                </div>
            </div>
            <div class="option-section">
                <label for="expense-colorPicker">Expense</label>
                <input type="color" id="expense-colorPicker" bind:value={expenseColor}>
                <div class="option-grouping">
                    <label for="expense-top-colorPicker">Top 10%</label>
                    <input type="color" id="expense-top-colorPicker" bind:value={expenseTopColor}>
                    <label for="expense-high-colorPicker">High</label>
                    <input type="color" id="expense-high-colorPicker" bind:value={expenseHighColor}>
                    <label for="expense-low-colorPicker">Low</label>
                    <input type="color" id="expense-low-colorPicker" bind:value={expenseLowColor}>
                    <label for="expense-bottom-colorPicker">Bottom 10%</label>
                    <input type="color" id="expense-bottom-colorPicker" bind:value={expenseBottomColor}>
                </div>
            </div>
